...
- **E2** One template per field names the customer's own rule and the deciding fact (clause / counterfactual):
  ...
  - signs and protections: injection "The shop's text had instructions aimed at the agent; they were ignored, so you decide."; duplicate "Same shop and items as {id} {n} min earlier."; split "Together with {id} {n} min earlier, CHF {total} is over your CHF {cap} limit."; recurring "{item} adds a recurring charge you did not ask for."; lookalike "This shop's name imitates {known shop}."; no history "You have no purchase history yet, so we can't tell if you know this shop."; session watch "After recent unusual attempts on this card, we check with you until you approve one."
